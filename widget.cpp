      ...
      m_channelNumber(4)//if channelnumber is added, should be changed!!!
{
    ...
    QVBoxLayout *partLayout1 = new QVBoxLayout;
    QGridLayout *partLayout2 = new QGridLayout;

    m_button = new QPushButton;
    m_button1 = new QPushButton;
    m_text_browser = new QTextBrowser;
    gridGroupBox = new QGroupBox(tr("Infos"));

    m_button->setText("connect");
    m_button1->setText("run");
    m_button1->hide();

    m_layout->itemAtPosition(1,2);
    m_layout->setColumnStretch(0,10);
    m_layout->addLayout(mainLayout1,0,0);
    m_layout->addLayout(mainLayout2,0,1);


    mainLayout2->itemAtPosition(2,1);
    mainLayout2->setRowStretch(0,10);
    mainLayout2->setRowStretch(1,20);
    gridGroupBox->setLayout(mainLayout2);
    mainLayout2->addLayout(partLayout1,0,0);
    mainLayout2->addLayout(partLayout2,1,0);
    partLayout1->addWidget(m_text_browser);
    partLayout2->addWidget(m_button,0,0,0);
    partLayout2->addWidget(m_button1,0,1,0);

    m_text_browser->setMinimumSize(QSize(40,80));

    QFont font = QFont ("Courier");
    font.setStyleHint (QFont::Monospace);
    font.setPointSize (12);
    font.setFixedPitch (true);
    m_text_browser->setFont(font);
    m_text_browser->setTextColor(Qt::blue);
    ...
    for(qint64 i = 0; i < m_channelNumber; i++){
        ...
        mainLayout1->addWidget(chartView);
    }
